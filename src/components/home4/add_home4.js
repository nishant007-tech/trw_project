...
class AddHome4 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "",
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      axios
        .post(
          "https://trw-backend-api.herokuapp.com/home/AddHome4",
      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Home Section 4 - Add New</div>
