...
class AddEventCat extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            event_category: "",
    ...
    handleSubmit(event) {
        ...
        if (this.validator.allValid()) {
            ...
            axios
                .post(
                    `https://trw-backend-api.herokuapp.com/blog/add_event_cat`,
                    menu
                )
                .then((res) => {
                    console.log(res);
            ...
            <div>
                ...
                <div className="admin-wrapper col-12">
                    <div className="admin-content">
                        <div className="admin-head">Add New Event Category</div>
